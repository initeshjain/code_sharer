    ...
    <div className="flex items-center justify-between p-1 px-3 md:px-10 shadow-sm border-b-[1px] sticky top-0 bg-white dark:bg-black dark:text-white z-10">
      ...
      <div className="flex gap-4">
        <Link
          ...
          target="_blank"
          className="flex items-center gap-2 justify-center rounded-md border border-transparent bg-blue-100 px-2 py-1 text-sm font-medium text-blue-900 hover:bg-blue-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
        >
          <svg
